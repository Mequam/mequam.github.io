...
function generatePlaceholder()
{
	if (true)//!Modernizr.input.placeholder)
	{
		...
		//cross platform way to attach diferent events to the text element
		if (addressBox.addEventListener)
		{
			//when the text box focuses zero the place holder, 
			//only if the place is holder is there
			addressBox.addEventListener("focus",zeroPlaceholder,false);
			//when the text box loses focus, add the place holder only if theres no text
